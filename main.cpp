...
public:
    ...
    JSONValue(string value) : type(JSONValueType::String), stringValue(std::move(value)) {}
...
class JSONParser {
public:
    explicit JSONParser(string jsonString) : jsonString(std::move(jsonString)), index(0) {}
